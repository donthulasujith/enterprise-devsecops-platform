...
const accessControlChallenges = () => (req, res, next) => {
    ...
    challengeUtils.solveIf(datacache_1.challenges.scoreBoardChallenge, () => { return utils.endsWith(url, '/1px.png'); }, false, uiBypassed);
    challengeUtils.solveIf(datacache_1.challenges.web3SandboxChallenge, () => { return utils.endsWith(url, '/11px.png'); }, false, uiBypassed);
    challengeUtils.solveIf(datacache_1.challenges.adminSectionChallenge, () => { return utils.endsWith(url, '/19px.png'); }, false, uiBypassed);
    challengeUtils.solveIf(datacache_1.challenges.tokenSaleChallenge, () => { return utils.endsWith(url, '/56px.png'); }, false, uiBypassed);
    challengeUtils.solveIf(datacache_1.challenges.privacyPolicyChallenge, () => { return utils.endsWith(url, '/81px.png'); }, false, uiBypassed);
...
exports.SYSTEM_PROMPT_SIMILARITY_THRESHOLD = 0.25;
...
function checkSystemPromptSimilarity(submission, reference, threshold = exports.SYSTEM_PROMPT_SIMILARITY_THRESHOLD) {
